<script>
    ...
    import logo_pic from '$lib/img/logo_pic.png'
</script>

<Heading text="About KB&G" />
<img src={logo_pic} alt="jayren logo" class="w-4/5 ml-12 max-w-[400px]" />
<div class="text-center max-w-[400px]">
    <h2 class="font-semibold text-xl">Who we are</h2>
    <p>
